    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a
                        href="${pageContext.request.contextPath}/user/findAll">入口管理</a></li>
                                ...
                                <c:forEach items="${pageInfo.list}" var="record">
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="${pageContext.request.contextPath}/record/addRecord?carNumber=${record.carNumber}" class="btn bg-olive btn-xs">办理月票用户</a>
                                        </td>
                                    </tr>
                                </c:forEach>
                                </tbody>

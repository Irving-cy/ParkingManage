    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a
                        href="${pageContext.request.contextPath}/chukou/findAll">出口管理</a></li>
                <li class="active">出库车辆</li>
            </ol>
        </section>
        <!-- 内容头部 /-->

        <form action="${pageContext.request.contextPath}/chukou/update"
              method="post">
            <!-- 正文区域 -->
